...
//  FinalProject
//
//  Created by Ceren Çiçek on 24.04.2022.
//
...
class UploadPostController: UIViewController {
    ...
    func configureUI() {
        ...
        photoImageView.setDimensions(height:300, width: 300)
        photoImageView.anchor(top: view.safeAreaLayoutGuide.topAnchor, paddingTop: 50)
        photoImageView.centerX(inView: view)
        photoImageView.layer.cornerRadius = 10

        view.addSubview(captionTextView)
        captionTextView.anchor(top: photoImageView.bottomAnchor, left: view.leftAnchor,
                               right: view.rightAnchor, paddingTop: 16, paddingLeft: 12, paddingRight: 12, height: 64)
