...
extension UIButton {
    ...
    func attributedTitle(firstSentence: String, secondSentence: String) {
        ...
        let attributedTitle = NSMutableAttributedString(string: "\(firstSentence) ", attributes: atts)

        let boldAtts : [NSAttributedString.Key: Any] = [.foregroundColor: UIColor(white: 1, alpha: 1), .font: UIFont.boldSystemFont(ofSize: 16)]
        attributedTitle.append(NSAttributedString(string: secondSentence, attributes: boldAtts))
